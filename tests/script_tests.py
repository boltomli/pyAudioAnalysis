...
[Fs, x] = audioBasicIO.read_audio_file(
    root_data_path + "pyAudioAnalysis/data/count.wav"
)
...
print("\n\n\n * * * TEST 2 * * * \n\n\n")
[Fs, x] = audioBasicIO.read_audio_file(
    root_data_path + "pyAudioAnalysis/data/doremi.wav"
)
x = audioBasicIO.stereo_to_mono(x)
specgram, TimeAxis, FreqAxis = ShortTermFeatures.spectrogram(
    x, Fs, round(Fs * 0.040), round(Fs * 0.040), True, True
)
...
aT.extract_features_and_train(
    [root_data_path + "speakerAll/F1/", root_data_path + "speakerAll/F2/"],
    1.0,
    1.0,
    0.2,
    0.2,
...
[flagsInd, classesAll, acc, CM] = aS.mid_term_file_classification(
    root_data_path + "scottish.wav",
    root_data_path + "models/svm_rbf_sm",
    "svm_rbf",
    True,
...
aS.train_hmm_from_file(
    root_data_path + "radioFinal/train/bbc4A.wav",
...
aT.feature_extraction_train_regression(
    root_data_path + "pyAudioAnalysis/data/speechEmotion",
    1,
    1,
    0.050,
    0.050,
...
print(
    aT.file_regression(
        root_data_path + "pyAudioAnalysis/data/speechEmotion/01.wav", "temp.mod", "svm"
    )
)
