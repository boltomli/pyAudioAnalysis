...
def parseArguments():
    ...
    parser.add_argument(
        ...
        "--data_folder",
        nargs=None,
        default="/Users/tyiannak/ResearchData/" "Audio Dataset/pyAudioAnalysisData/",
    )
    parser.add_argument(
        "-c",
        "--classifier_type",
...
if __name__ == "__main__":
    ...
    if args.task == "sm":
        aT.extract_features_and_train(
            [root_data_path + "SM/speech", root_data_path + "SM/music"],
            1.0,
            1.0,
            0.05,
            0.05,
        ...
        aT.extract_features_and_train(
            ...
            0.05,
            classifier_type,
            classifier_type + "_movie8class",
            False,
        )
    elif args.task == "speakers":
        aT.extract_features_and_train(
            [
                root_data_path + "speakerAll/F1",
            ...
            0.05,
            classifier_type,
            classifier_type + "_speaker_10",
            False,
        )
    elif args.task == "speaker-gender":
        aT.extract_features_and_train(
            [
                root_data_path + "speakerMaleFemale/Male",
            ...
            0.05,
            classifier_type,
            classifier_type + "_speaker_male_female",
            False,
        )
    elif args.task == "music-genre6":
        aT.extract_features_and_train(
            [
                root_data_path + "musicalGenreClassification/Blues",
            ...
            0.05,
            classifier_type,
            classifier_type + "_musical_genre_6",
            True,
        )
    elif args.task == "4class":
        aT.extract_features_and_train(
            [
                root_data_path + "4class/speech",
